...
run_sweep_and_agent "mnist_cross_device_NON_iid"
run_sweep_and_agent "mnist_cross_silo_NON_iid"
run_sweep_and_agent "mnist_cross_device_iid"
run_sweep_and_agent "mnist_cross_silo_iid"
